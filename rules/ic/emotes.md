...
1. **Etrafta olan biten bir olayı anlatmak veya betimleme yapmak için kullanılır.**
   ...
   **Etrafınızda olan bir olayı belirtmek veya betimlemek için kullanılır.**
...
2. **Emote gerektirmeyen animasyonlara daha fazla detay katmak için kullanılır.**
   ...
   - Elinizde çiçek tutma animasyonu yaparken; /do Elindeki çiçek buketinde lilyumlar ve orkideler görülmektedir.
