...
- 6 adet konsept araç olmalıdır. (Konseptinize göre spor veya motor) (Her bir üyeye 1 adet denk gelecek şekilde)
...
- Hood onaylı ekip statüsü alabilmek için yönetim tarafından onaylanmanız gerekmektedir. Bu onayın verilmesinde, ekibinizin yürüttüğü rollerin kalitesi ve süreç içerisindeki performansı dikkate alınır.
...
- Konsept araç sayısı her zaman 6 olmalı ve düzenli olarak kullanılmalıdır. (Almış olmak için alınan araçlar tespit edilirse onaylı birlik süreci düşer)
- Bölgenizde düzenli olarak yarışlar yapılmalı ve bunu eyalete yaymalısınız. Konsept dışı davranışlar veya yarışlar konseptinizden çıktığınıza işarettir ve onaylı birlik sürecinden men edilirsiniz.
