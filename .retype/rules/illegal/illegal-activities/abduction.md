...
- Kaçırma eylemi sonrasında kaçırılan kişi fear rp kurallarına uygun davranışlar sergilemelidir. Bu rolün dozajı iki taraf için farklılık gösterse de makul korku rolleri gerçekleştirilmelidir. (Korkutuğuna dair ses titremesi, kekemelik, hayatına dair endişe, ağlama)
- Kaçırma eyleminde korkusuzca gerçekleştirilen roller sonrasında yönetim tarafından CK yetkisi, kalıcı yara izni karşı tarafa verilebilir veya yönetim tarafından CK edilebilir. 
- Kaçırma eyleminden sonra fidye talep edilemez.
- Kaçırma eyleminde kaçırılan kişi veya kişiler için muhbir olmak gibi kritik konularda zorlama roller yapılamaz.
- Kaçırma eyleminde polislere badcop rolü dayatılamaz. Aynı şekilde polis olarak edindiği bilgi ve deneyimlerini kullanmak/söylemek için zorlanamaz.
...
- Alıkoyma eyleminde toplamda en az 6 kişi gerekir. Bir seferde yalnızca 1 kişi alıkoyulabilir.
...
- Alıkoyma eyleminde kaçırılan kişi veya kişiler muhbir olmak gibi kritik konularda zorlama roller yapılamaz. 
- Alıkoyma eyleminde alıkoyulan kişi 4 saat tutulabilir. 
- Alıkoyma eyleminde fidye istenebilir. Fidye kurallarında olduğu gibi maksimum 50.000$ talep edilebilir. (Bu konuda para harici taleplerde makul olmanız beklenir) 
